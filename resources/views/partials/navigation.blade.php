    ...
    <div class="row">
        ...
        <div class="col-xs-9 text-right menu-1">
            <form class="row d-flex justify-content-end align-items-center" method="POST" action="{{ route('logout') }}">
                <a class="text-reset @if($cart) notification-badge @endif" href="{{ route('cart') }}"><i class="fs-1 icon-shopping-cart" style="color: @if(Auth::user()->gender == 'Male') #5d87ff @else #f14e95 @endif;"></i></a>
                @csrf
